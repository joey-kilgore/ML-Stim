// Controller.c uses the basic net defined in NN.h and NN.c to progressively learn and attempt
// to block action potentials generated by a continuous stimulus on an HH model (see Sim.h and Sim.c)
// This is a proof of concept for ML and nerve block technology, and TestFeedback.c is a more
// advanced version of this.
//
// This proof of concept was created in 24hrs by
// Joey Kilgore
// Adam Savel
// Brian Xiong
